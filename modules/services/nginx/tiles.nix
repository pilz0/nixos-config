...
let
  cfg = config.pilz.services.tilesproxy;
in
{
  options.pilz.services.tilesproxy = {
    enable = lib.mkEnableOption "";
    domain = lib.mkOption {
      type = lib.types.str;
      default = "tiles.as214958.net";
    };
    contact = lib.mkOption {
      type = lib.types.str;
      default = "mailto:ops@as214958.net";
    };
  };
    ...
    services.nginx = {
      ...
      virtualHosts.${cfg.domain} = {
        ...
        locations."/osm/" = {
          ...
          extraConfig = ''
            proxy_set_header User-Agent "Mozilla/5.0 (compatible; OSMTileCache/1.0; +${cfg.contact}; +https://${cfg.domain}/)";
